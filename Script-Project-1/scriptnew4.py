...
def main():
	...
	output.write("\n")
		...
		#open input file
	input_file = open("/storage/data/GLOBAL/usage_collection/total_usage.txt", "r")
	...
	#open input file
	input_file = open("/storage/data/GLOBAL/usage_collection/dept_site_usage.txt", "r")
	...
	# #full storage mockup
	ax1.plot(count_date, used_storage_graphs, c='b',marker="s", label='Full Storage Used')
	ax1.plot(count_date,total_storage_graphs, c='r',marker="s", label='Full Storage Total')


	#raw graphs
	ax2.plot(count_date,netapp_T1_raw_graphs , c='b',marker="s", label='T1 Raw')
	ax2.plot(count_date,netapp_T3_raw_graphs, c='r',marker="s", label='T3 Raw')
	ax2.plot(count_date,netapp_T3B_raw_graphs, c='y',marker="s", label='T3B Raw')
	ax2.plot(count_date,netapp_T4_raw_graphs, c='g',marker="s", label='T4 Raw')

	# #plot plots for tier and site
	# #sj T1 
	ax3.plot(count_date,sj_T1_used_graphs, c='b',marker="s", label='SJ T1 Used')
	ax3.plot(count_date,sj_T1_total_graphs, c='#32CD32',marker="s", label='SJ T1 Total')
	#sj T3
	ax3.plot(count_date,sj_T3_used_graphs , c='g',marker="s", label='SJ T3 Used')
	ax3.plot(count_date,sj_T3_total_graphs, c='r',marker="s", label='SJ T3 Total')
	#sj T3B
	ax3.plot(count_date,sj_T3B_used_graphs , c='m',marker="s", label='SJ T3B Used')
	ax3.plot(count_date,sj_T3B_total_graphs, c='c',marker="s", label='SJ T3B Total')
	#sj T4
	ax3.plot(count_date,sj_T4_used_graphs , c='y',marker="s", label='SJ T4 Used')
	ax3.plot(count_date,sj_T4_total_graphs, c='k',marker="s", label='SJ T4 Total')

	# #pg T1
	ax4.plot(count_date,pg_T1_used_graphs, c='b',marker="s", label='pg T1 Used')
	ax4.plot(count_date,pg_T1_total_graphs, c='w',marker="s", label='pg T1 Total')
	#pg T3
	ax4.plot(count_date,pg_T3_used_graphs , c='g',marker="s", label='pg T3 Used')
	ax4.plot(count_date,pg_T3_total_graphs, c='r',marker="s", label='pg T3 Total')
	#pg T3B
	ax4.plot(count_date,pg_T3B_used_graphs , c='m',marker="s", label='pg T3B Used')
	ax4.plot(count_date,pg_T3B_total_graphs, c='c',marker="s", label='pg T3B Total')
	#pg T4
	ax4.plot(count_date,pg_T4_used_graphs , c='y',marker="s", label='pg T4 Used')
	ax4.plot(count_date,pg_T4_total_graphs, c='k',marker="s", label='pg T4 Total')

	# #nl T1
	ax5.plot(count_date,nl_T1_used_graphs, c='b',marker="s", label='nl T1 Used')
	ax5.plot(count_date,nl_T1_total_graphs, c='#32CD32',marker="s", label='nl T1 Total')
	#nl T3
	ax5.plot(count_date,nl_T3_used_graphs , c='g',marker="s", label='nl T3 Used')
	ax5.plot(count_date,nl_T3_total_graphs, c='r',marker="s", label='nl T3 Total')
	#nl T3B
	ax5.plot(count_date,nl_T3B_used_graphs , c='m',marker="s", label='nl T3B Used')
	ax5.plot(count_date,nl_T3B_total_graphs, c='c',marker="s", label='nl T3B Total')
	#nl T4
	ax5.plot(count_date,nl_T4_used_graphs , c='y',marker="s", label='nl T4 Used')
	ax5.plot(count_date,nl_T4_total_graphs, c='k',marker="s", label='nl T4 Total')

	#uk T1
	ax6.plot(count_date,uk_T1_used_graphs, c='b',marker="s", label='uk T1 Used')
	ax6.plot(count_date,uk_T1_total_graphs, c='#32CD32',marker="s", label='uk T1 Total')
	#uk T3
	ax6.plot(count_date,uk_T3_used_graphs , c='g',marker="s", label='uk T3 Used')
	ax6.plot(count_date,uk_T3_total_graphs, c='r',marker="s", label='uk T3 Total')
	#uk T3B
	ax6.plot(count_date,uk_T3B_used_graphs , c='m',marker="s", label='uk T3B Used')
	ax6.plot(count_date,uk_T3B_total_graphs, c='c',marker="s", label='uk T3B Total')
	#uk T4
	ax6.plot(count_date,uk_T4_used_graphs , c='y',marker="s", label='uk T4 Used')
	ax6.plot(count_date,uk_T4_total_graphs, c='k',marker="s", label='uk T4 Total')

	#jp T1
	ax7.plot(count_date,jp_T1_used_graphs, c='b',marker="s", label='jp T1 Used')
	ax7.plot(count_date,jp_T1_total_graphs, c='#32CD32',marker="s", label='jp T1 Total')
	#jp T3
	ax7.plot(count_date,jp_T3_used_graphs , c='g',marker="s", label='jp T3 Used')
	ax7.plot(count_date,jp_T3_total_graphs, c='r',marker="s", label='jp T3 Total')
	#jp T3B
	ax7.plot(count_date,jp_T3B_used_graphs , c='m',marker="s", label='jp T3B Used')
	ax7.plot(count_date,jp_T3B_total_graphs, c='c',marker="s", label='jp T3B Total')
	#jp T4
	ax7.plot(count_date,jp_T4_used_graphs , c='y',marker="s", label='jp T4 Used')
	ax7.plot(count_date,jp_T4_total_graphs, c='k',marker="s", label='jp T4 Total')
	#hk T1
	ax8.plot(count_date,hk_T1_used_graphs, c='b',marker="s", label='hk T1 Used')
	ax8.plot(count_date,hk_T1_total_graphs, c='#32CD32',marker="s", label='hk T1 Total')
	#hk T3
	ax8.plot(count_date,hk_T3_used_graphs , c='g',marker="s", label='hk T3 Used')
	ax8.plot(count_date,hk_T3_total_graphs, c='r',marker="s", label='hk T3 Total')
	#hk T3B
	ax8.plot(count_date,hk_T3B_used_graphs , c='m',marker="s", label='hk T3B Used')
	ax8.plot(count_date,hk_T3B_total_graphs, c='c',marker="s", label='hk T3B Total')
	#hk T4
	ax8.plot(count_date,hk_T4_used_graphs , c='y',marker="s", label='hk T4 Used')
	ax8.plot(count_date,hk_T4_total_graphs, c='k',marker="s", label='hk T4 Total')


	#to T1
	ax9.plot(count_date,to_T1_used_graphs, c='b',marker="s", label='to T1 Used')
	ax9.plot(count_date,to_T1_total_graphs, c='#32CD32',marker="s", label='to T1 Total')
	#to T3
	ax9.plot(count_date,to_T3_used_graphs , c='g',marker="s", label='to T3 Used')
	ax9.plot(count_date,to_T3_total_graphs, c='r',marker="s", label='to T3 Total')
	#to T3B
	ax9.plot(count_date,to_T3B_used_graphs , c='m',marker="s", label='to T3B Used')
	ax9.plot(count_date,to_T3B_total_graphs, c='c',marker="s", label='to T3B Total')
	#to T4
	ax9.plot(count_date,to_T4_used_graphs , c='y',marker="s", label='to T4 Used')
	ax9.plot(count_date,to_T4_total_graphs, c='k',marker="s", label='to T4 Total')

	#at T1
	ax10.plot(count_date,at_T1_used_graphs, c='b',marker="s", label='at T1 Used')
	ax10.plot(count_date,at_T1_total_graphs, c='#32CD32',marker="s", label='at T1 Total')
	#to T3
	ax10.plot(count_date,at_T3_used_graphs , c='g',marker="s", label='at T3 Used')
	ax10.plot(count_date,at_T3_total_graphs, c='r',marker="s", label='at T3 Total')
	#to T3B
	ax10.plot(count_date,at_T3B_used_graphs , c='m',marker="s", label='at T3B Used')
	ax10.plot(count_date,at_T3B_total_graphs, c='c',marker="s", label='at T3B Total')
	#to T4
	ax10.plot(count_date,at_T4_used_graphs , c='y',marker="s", label='at T4 Used')
	ax10.plot(count_date,at_T4_total_graphs, c='k',marker="s", label='at T4 Total')
	...
	ax11.plot(count_date,ice_T1_used_graphs, c='b',marker="s", label='ice T1 Used')
	ax11.plot(count_date,ice_T1_total_graphs, c='#32CD32',marker="s", label='ice T1 Total')
	ax11.plot(count_date,ice_T3_used_graphs , c='g',marker="s", label='ice T3 Used')
	ax11.plot(count_date,ice_T3_total_graphs, c='r',marker="s", label='ice T3 Total')
	ax11.plot(count_date,ice_T3B_used_graphs , c='m',marker="s", label='ice T3B Used')
	ax11.plot(count_date,ice_T3B_total_graphs, c='c',marker="s", label='ice T3B Total')
	ax11.plot(count_date,ice_T4_used_graphs , c='y',marker="s", label='ice T4 Used')
	ax11.plot(count_date,ice_T4_total_graphs, c='k',marker="s", label='ice T4 Total')


	#swip
	ax12.plot(count_date,swip_T1_used_graphs , c='y', marker="s", label='swip Used')
	ax12.plot(count_date,swip_T1_total_graphs , c='k', marker="s", label='swip Total')
	ax12.plot(count_date,swip_T1_used_graphs, c='b',marker="s", label='swip T1 Used')
	ax12.plot(count_date,swip_T1_total_graphs, c='#32CD32',marker="s", label='swip T1 Total')
	ax12.plot(count_date,swip_T3_used_graphs , c='g',marker="s", label='swip T3 Used')
	ax12.plot(count_date,swip_T3_total_graphs, c='r',marker="s", label='swip T3 Total')
	ax12.plot(count_date,swip_T3B_used_graphs , c='m',marker="s", label='swip T3B Used')
	ax12.plot(count_date,swip_T3B_total_graphs, c='c',marker="s", label='swip T3B Total')
	ax12.plot(count_date,swip_T4_used_graphs , c='y',marker="s", label='swip T4 Used')
	ax12.plot(count_date,swip_T4_total_graphs, c='k',marker="s", label='swip T4 Total')

	#it
	ax13.plot(count_date,it_T1_used_graphs , c='y', marker="s", label='IT Used')
	ax13.plot(count_date,it_T1_total_graphs , c='k', marker="s", label='IT Total')
	ax13.plot(count_date,it_T1_used_graphs, c='b',marker="s", label='IT T1 Used')
	ax13.plot(count_date,it_T1_total_graphs, c='#32CD32',marker="s", label='IT T1 Total')
	ax13.plot(count_date,it_T3_used_graphs , c='g',marker="s", label='IT T3 Used')
	ax13.plot(count_date,it_T3_total_graphs, c='r',marker="s", label='IT T3 Total')
	ax13.plot(count_date,it_T3B_used_graphs , c='m',marker="s", label='IT T3B Used')
	ax13.plot(count_date,it_T3B_total_graphs, c='c',marker="s", label='IT T3B Total')
	ax13.plot(count_date,it_T4_used_graphs , c='y',marker="s", label='IT T4 Used')
	ax13.plot(count_date,it_T4_total_graphs, c='k',marker="s", label='IT T4 Total')

	#wwoe
	ax14.plot(count_date,wwoe_T1_used_graphs , c='y', marker="s", label='wwoe Used')
	ax14.plot(count_date,wwoe_T1_total_graphs , c='k', marker="s", label='wwoe Total')
	ax14.plot(count_date,wwoe_T1_used_graphs, c='b',marker="s", label='wwoe T1 Used')
	ax14.plot(count_date,wwoe_T1_total_graphs, c='#32CD32',marker="s", label='wwoe T1 Total')
	ax14.plot(count_date,wwoe_T3_used_graphs , c='g',marker="s", label='wwoe T3 Used')
	ax14.plot(count_date,wwoe_T3_total_graphs, c='r',marker="s", label='wwoe T3 Total')
	ax14.plot(count_date,wwoe_T3B_used_graphs , c='m',marker="s", label='wwoe T3B Used')
	ax14.plot(count_date,wwoe_T3B_total_graphs, c='c',marker="s", label='wwoe T3B Total')
	ax14.plot(count_date,wwoe_T4_used_graphs , c='y',marker="s", label='wwoe T4 Used')
	ax14.plot(count_date,wwoe_T4_total_graphs, c='k',marker="s", label='wwoe T4 Total')
	...
	ax1.set_xlabel('Date(MM/DD/YYYY)', fontsize=8)
	ax2.set_xlabel('Date(MM/DD/YYYY)', fontsize=8)
	ax3.set_xlabel('Date(MM/DD/YYYY)', fontsize=8)
	ax4.set_xlabel('Date(MM/DD/YYYY)', fontsize=8)
	ax5.set_xlabel('Date(MM/DD/YYYY)', fontsize=8)
	ax6.set_xlabel('Date(MM/DD/YYYY)', fontsize=8)
	ax7.set_xlabel('Date(MM/DD/YYYY)', fontsize=8)
	ax8.set_xlabel('Date(MM/DD/YYYY)', fontsize=8)
	ax9.set_xlabel('Date(MM/DD/YYYY)', fontsize=8)
	ax10.set_xlabel('Date(MM/DD/YYYY)', fontsize=8)
	ax11.set_xlabel('Date(MM/DD/YYYY)', fontsize=8)
	ax12.set_xlabel('Date(MM/DD/YYYY)', fontsize=8)
	ax13.set_xlabel('Date(MM/DD/YYYY)', fontsize=8)
	ax14.set_xlabel('Date(MM/DD/YYYY)', fontsize=8)

	ax1.set_ylabel('GB', fontsize=8)
	ax2.set_ylabel('GB', fontsize=8)
	ax3.set_ylabel('GB', fontsize=8)
	ax4.set_ylabel('GB', fontsize=8)
	ax5.set_ylabel('GB', fontsize=8)
	ax6.set_ylabel('GB', fontsize=8)
	ax7.set_ylabel('GB', fontsize=8)
	ax8.set_ylabel('GB', fontsize=8)
	ax9.set_ylabel('GB', fontsize=8)
	ax10.set_ylabel('GB', fontsize=8)
	ax11.set_ylabel('GB', fontsize=8)
	ax12.set_ylabel('GB', fontsize=8)
	ax13.set_ylabel('GB', fontsize=8)
	ax14.set_ylabel('GB', fontsize=8)

	ax1.yaxis.set_major_formatter(y_format)
	ax2.yaxis.set_major_formatter(y_format)
	ax3.yaxis.set_major_formatter(y_format)
	ax4.yaxis.set_major_formatter(y_format)
	ax5.yaxis.set_major_formatter(y_format)
	ax6.yaxis.set_major_formatter(y_format)
	ax7.yaxis.set_major_formatter(y_format)
	ax8.yaxis.set_major_formatter(y_format)
	ax9.yaxis.set_major_formatter(y_format)
	...
	ax14.yaxis.set_major_formatter(y_format)
	...
	#have to touch file since weird error is being generated.
	x='/storage/data/GLOBAL/usage_images/full_storage_'+netapp_date[1]+'.png'
	
	open(x, 'a').close()

	plt.setp(ax1,xticks=count_date,xticklabels=unique_dates)
	fig.savefig('/storage/data/GLOBAL/usage_images/full_storage_'+netapp_date[1]+'.png')
	plt.setp(ax2,xticks=count_date,xticklabels=unique_dates)
	fig2.savefig('/storage/data/GLOBAL/usage_images/raw_storage_'+netapp_date[1]+'.png')
	plt.setp(ax3,xticks=count_date,xticklabels=unique_dates)
	fig3.savefig('/storage/data/GLOBAL/usage_images/sj_'+netapp_date[1]+'.png')
	plt.setp(ax4,xticks=count_date,xticklabels=unique_dates)
	fig4.savefig('/storage/data/GLOBAL/usage_images/pg_'+netapp_date[1]+'.png')
	plt.setp(ax5,xticks=count_date,xticklabels=unique_dates)
	fig5.savefig('/storage/data/GLOBAL/usage_images/nl_'+netapp_date[1]+'.png')
	plt.setp(ax6,xticks=count_date,xticklabels=unique_dates)
	fig6.savefig('/storage/data/GLOBAL/usage_images/uk_'+netapp_date[1]+'.png')
	plt.setp(ax7,xticks=count_date,xticklabels=unique_dates)
	fig7.savefig('/storage/data/GLOBAL/usage_images/jp_'+netapp_date[1]+'.png')
	plt.setp(ax8,xticks=count_date,xticklabels=unique_dates)
	fig8.savefig('/storage/data/GLOBAL/usage_images/hk_'+netapp_date[1]+'.png')
	plt.setp(ax9,xticks=count_date,xticklabels=unique_dates)
	fig9.savefig('/storage/data/GLOBAL/usage_images/to_'+netapp_date[1]+'.png')
	plt.setp(ax10,xticks=count_date,xticklabels=unique_dates)
	fig10.savefig('/storage/data/GLOBAL/usage_images/at_'+netapp_date[1]+'.png')
	plt.setp(ax11,xticks=count_date,xticklabels=unique_dates)
	fig11.savefig('/storage/data/GLOBAL/usage_images/ice_'+netapp_date[1]+'.png')
	plt.setp(ax12,xticks=count_date,xticklabels=unique_dates)
	fig12.savefig('/storage/data/GLOBAL/usage_images/swip_'+netapp_date[1]+'.png')
	plt.setp(ax13,xticks=count_date,xticklabels=unique_dates)
	fig13.savefig('/storage/data/GLOBAL/usage_images/it_'+netapp_date[1]+'.png')
	plt.setp(ax14,xticks=count_date,xticklabels=unique_dates)
	fig14.savefig('/storage/data/GLOBAL/usage_images/wwoe_'+netapp_date[1]+'.png')
